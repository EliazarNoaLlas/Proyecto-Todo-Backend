...
describe("Functional Tests", () => {
  ...
  describe("ToDo API", () => {
    it("should save a new todo", async () => {
      const newTodo = { toDo: "New Functional Task" };
    ...
    it("should get all todos", async () => {
      ...
      await ToDoModel.create({ toDo: "Functional Task 1" });
      await ToDoModel.create({ toDo: "Functional Task 2" });
    ...
    it("should update an existing todo", async () => {
      ...
      const updatedTodo = { toDo: "Updated Functional Task" };
    ...
    it("should delete an existing todo", async () => {
      // Agregar una tarea de prueba a la base de datos
      const existingTodo = await ToDoModel.create({ toDo: "Functional Task to Delete" });

      // Realizar la solicitud DELETE a la API para eliminar la tarea
